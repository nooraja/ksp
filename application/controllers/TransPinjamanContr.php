...
* 
*/
class TransPinjamanContr extends CI_Controller
{
	...
	public function __construct()
    {
        ...
        $this->load->model('ModelTransPinjaman' ,'pinjaman');
    ...
    public function getKeputusan()
    {
        $anggota = $this->db->select('keputusan.id_keputusan, keputusan.jenis_kptsn')
                                ->where('keputusan.id_keputusan not in (SELECT bukti_transaksi_pinjaman.id_keputusan FROM bukti_transaksi_pinjaman) and keputusan.jenis_kptsn = "Bukti Pinjaman" ')
                                ->get('keputusan');
                                
        echo json_encode($anggota->result_array());
    }
    public function viewTransPinjaman()
    {
        ...
        $this->load->view('pinjaman/contenttranspinjaman', $d);
    }
	...
	public function ajax_list()
    {
        ...
        foreach ($list as $pinjaman) {
            ...
            $row[] = $pinjaman->pinjaman_terbayar;
