                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <div class="btn-group pull-right">
                                <button class="btn btn-danger btn-xs" onclick="add_slot()" data-toggle="modal" data-target=""><i class="glyphicon glyphicon-plus" data-toggle="tooltip" title="Add category"></i></button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title">Slot Form</h3>
                    </div>
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="id_Slot" id="id_Slot"  class="form-control" type="text" value="<?php echo set_value('id_Slot', 'SL'.rand(0000, 9999)); ?>" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="id_KWM" id="id_KWM" placeholder="Kelompok" class="form-control" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="id_anggota" id="id_anggota" placeholder="" class="form-control" type="text" 
                                        <span class="help-block"></span>
                                    </div>
                                </div>
 -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="status_slot" id="status_slot" placeholder="Status Slot 1 = ya dan 2 = tidak" class="form-control" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table').DataTable({ 
                ...
                "ajax": {
                    "url": "<?php echo base_url();?>slotcontr/ajax_list",
                    "type": "POST"
                },
        ...
        function add_slot()
        {
            ...
            $('.modal-title').text('Tambah Slot'); // Set Title to Bootstrap modal title
        }
        ...
        function edit_slot(id)
        {
            ...
            $.ajax({
                url : "<?php echo base_url();?>slotcontr/ajax_edit/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                    ...
                    $('.modal-title').text('Edit Slot'); // Set title to Bootstrap modal title
        ...
        function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo base_url();?>slotcontr/ajax_add";
            } else {
                url = "<?php echo base_url();?>slotcontr/ajax_update";
            }
        ...
        function delete_slot(id)
        {
            if(confirm('Are you sure delete this data?'))
            {
                ...
                $.ajax({
                    url : "<?php echo base_url();?>slotcontr/ajax_delete/"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
    ...
    <script type="text/javascript">
        ...
        var optkwm = {
            ...
            template: {
             ...
             method: function(value, item) {
                  // return item.nama_koperasi + " || " + item.cantHabit + " || " + item.idCiudad;
                return item.nama_Kelompok + " || " + item.id_KWM ;
             }
            },
            ...
            list: {
                ...
                // },
                onClickEvent: function() {
                    var value = $("#id_KWM").getSelectedItemData().id_KWM;
                    $("#id_KWM").val(value).trigger("change");
                },
                onKeyEnterEvent: function(){
                    var value = $("#id_KWM").getSelectedItemData().id_KWM;

                    $("#id_KWM").val(value).trigger("id_KWM");
                }
            }
        };
        $("#id_KWM").easyAutocomplete(optkwm);
    </script>
    <script type="text/javascript">
        
        var optkp = {
            // url: "<?php echo base_url();?>js/countries.json",
            url: "<?php echo base_url();?>datos/getkeputusan",
            // url: "<?php echo base_url();?>koperasi/getkoperasi",
        ...
        $("#id_keputusan").easyAutocomplete(optkp);
    </script>
</body>
