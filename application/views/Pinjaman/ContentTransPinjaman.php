        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Bukti Transaksi Pinjaman</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Tabel Bukti Transaksi Pinjaman
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select name="id_Administrasi" id="id_Administrasi" class="form-control">
                                            ...
                                            <option value="ADS001">Administrasi</option>
                                        </select>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="cicilan" maxlength="2" name="cicilan" placeholder="Biaya Cicilan" class="form-control" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-3">Pinjaman Terbayar</label>
                                    <div class="col-md-9">
                        ...
                        <form action="#" id="former" class="form-horizontal">
                            <div class="form-group">
                                <div class="col-md-9">
                                    ...
                                    <input name="jenis_kptsn" placeholder="" value="Bukti Pinjaman" class="form-control" type="hidden">
                                    ...
                                    <input name="description" placeholder="" value="Bukti Pinjaman" class="form-control" type="hidden">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </form>
    ...
    <script type="text/javascript">
        var optionsid = {
            url: "<?php echo base_url();?>transpinjamancontr/getjenissimpanan",
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url();?>transpinjamancontr/ajax_list",
                "type": "POST"
            },
    ...
    function add_pinjaman()
    {
        ...
        // $('.modal-title').text('Keputusan Pinjaman'); // Set Title to Bootstrap modal title

        $('#form')[0].reset(); // reset form on modals
        $('.form-group').removeClass('has-error'); // clear error class
        $('.help-block').empty(); // clear error string
        $('#myModal').modal('show'); // show bootstrap modal
        $('.modal-title').text('Tambah Bukti Transaksi Pinjaman '); // Set Title to Bootstrap modal title
    }
    ...
    function savekptsn() {
        ...
        $.ajax({
            url : "<?php echo base_url();?>transpinjamancontr/ajax_keputusan/",
    ...
    function edit_pinjaman(id)
    {
        ...
        $.ajax({
            url : "<?php echo base_url();?>transpinjamancontr/ajax_edit/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="pinjaman_terbayar"]').val(data.pinjaman_terbayar);
                $('[name="jumlah_TransPinjaman"]').val(data.jumlah_TransPinjaman);
                $('[name="dateby"]').datepicker('update',data.dateby);
                $('[name="description"]').val(data.description);
                $('#myModal').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Edit Bukti Transaksi Pinjaman'); // Set title to Bootstrap modal title
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo base_url();?>transpinjamancontr/ajax_add";
        } else {
            url = "<?php echo base_url();?>transpinjamancontr/ajax_update";
        }
    ...
    function delete_pinjaman(id)
    {
        if(confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url : "<?php echo base_url();?>transpinjamancontr/ajax_delete/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
