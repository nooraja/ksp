                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <div class="btn-group pull-right">
                                <button class="btn btn-danger btn-xs" onclick="add_jenis()" data-toggle="modal" data-target=""><i class="glyphicon glyphicon-plus" data-toggle="tooltip" title="Add category"></i></button>
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">No Jenis</label>
                                    <div class="col-md-9">
                                        <input name="id_Jenis_Pinjaman"  class="form-control" type="text" value="<?php echo set_value('id_Jenis_Pinjaman', 'JB'.rand(1000, 9999)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="nama_pinjaman" placeholder="nomer rekening anggota" class="form-control" type="text" >
                                        <input name="id_Staff_Pembuat" placeholder="Last Name" class="form-control" type="hidden">
                                        <input name="id_Staff_Mod" placeholder="Last Name" class="form-control" type="hidden">
                                        <span class="help-block"></span>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-3">Nama Service</label>
                                    <div class="col-md-9">
                                        <input name="nama_pinjaman" placeholder="nama pembayaran" class="form-control" type="text" >
                                        <input name="id_Staff_Pembuat" placeholder="Last Name" class="form-control" type="hidden">
                                        <input name="id_Staff_Mod" placeholder="Last Name" class="form-control" type="hidden">
                                        <span class="help-block"></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="nama_pinjaman" placeholder="jenis pembayaran" class="form-control" type="text" >
                                        <input name="id_Staff_Pembuat" placeholder="Last Name" class="form-control" type="hidden">
                                        <input name="id_Staff_Mod" placeholder="Last Name" class="form-control" type="hidden">
                                        <span class="help-block"></span>
                                    </div>
                               ...
                               <!--  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="nama_pinjaman" placeholder="" class="form-control" type="text" >
                                        <input name="id_Staff_Pembuat" placeholder="Last Name" class="form-control" type="hidden">
                                        <input name="id_Staff_Mod" placeholder="Last Name" class="form-control" type="hidden">
                                        <span class="help-block"></span>
                                    </div>
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url();?>jpcontr/ajax_list",
                "type": "POST"
            },
    ...
    function add_jenis()
    {
        ...
        $('.modal-title').text('Tambah Jenis Pembayaran'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_jenis(id)
    {
        ...
        $.ajax({
            url : "<?php echo base_url();?>jpcontr/ajax_edit/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="nama_pinjaman"]').val(data.nama_pinjaman);
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo base_url();?>jpcontr/ajax_add";
        } else {
            url = "<?php echo base_url();?>jpcontr/ajax_update";
        }
    ...
    function delete_jenis(id)
    {
        if(confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url : "<?php echo base_url();?>jpcontr/ajax_delete/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
