                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">No Premi</label>
                                    <div class="col-md-9">
                                        <input name="id_Premi" class="form-control" type="text" value="<?php echo set_value('id_Premi', 'PRE'.rand(100, 999)); ?>">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Nama Premi</label>
                                    <div class="col-md-9">
                                        <input name="nama_premi" placeholder="Nama Premi" class="form-control" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input id="nilai" name="nilai" placeholder="Jumlah Premi" class="form-control" type="text">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Jenis Premi</label>
                                    <div class="col-md-9">
                                        <input name="nama_premi" placeholder="Jenis Premi" class="form-control" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url();?>premicontr/ajax_list",
                "type": "POST"
            },
    ...
    function add_biaya()
    {
        ...
        $('.modal-title').text('Tambah Premi'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_biaya(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('.modal-title').text('Edit Premi'); // Set title to Bootstrap modal title
