        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Jenis Pinjaman</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="id_Jenis_Pinjaman"  class="form-control" type="text" value="<?php echo set_value('id_Jenis_Pinjaman', 'JP'.rand(1000, 9999)); ?>">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Nama Pinjaman</label>
                                    <div class="col-md-9">
                                        <input name="nama_pinjaman" placeholder="Nama Pinjaman" class="form-control" type="text" >
    ...
    function add_jenis()
    {
        ...
        $('.modal-title').text('Tambah Jenis Pinjaman'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_jenis(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('.modal-title').text('Edit Jenis Pinjaman'); // Set title to Bootstrap modal title
