                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="id_Jenis_Pinjaman"  class="form-control" type="text" value="<?php echo set_value('id_Jenis_Pinjaman', 'AGM'.rand(100, 999)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="nama_pinjaman" placeholder="Nama Agama" class="form-control" type="text" >
    ...
    function edit_jenis(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('.modal-title').text('Kelola Data Agama'); // Set title to Bootstrap modal title
