        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Jenis Simpanan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="id_Jenis_Simpanan"  class="form-control" type="text" value="<?php echo set_value('id_Jenis_Simpanan', 'ADS'.rand(100, 999)); ?>">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Nama Simpanan</label>
                                    <div class="col-md-9">
                                        <input name="nama_simpanan" placeholder="Nama Simpanan" class="form-control" type="text" >
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url();?>jscontr/ajax_list",
                "type": "POST"
            },
    ...
    function edit_jenis(id)
    {
        ...
        $.ajax({
            url : "<?php echo base_url();?>jscontr/ajax_edit/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="nama_simpanan"]').val(data.nama_simpanan);
                ...
                $('.modal-title').text('Edit Jenis Simpanan'); // Set title to Bootstrap modal title
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo base_url();?>jscontr/ajax_add";
        } else {
            url = "<?php echo base_url();?>jscontr/ajax_update";
        }
    ...
    function delete_jenis(id)
    {
        if(confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url : "<?php echo base_url();?>jscontr/ajax_delete/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
