        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Administrasi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">No Administrasi</label>
                                    <div class="col-md-9">
                                        <input name="id_Administrasi"  class="form-control" type="text" value="<?php echo set_value('id_Administrasi', 'ADS'.rand(100, 999)); ?>">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">Nama Administrasi</label>
                                    <div class="col-md-9">
                                        <input name="nama_administrasi" placeholder="Nama Administrasi" class="form-control" type="text" >
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="nilai" name="nilai" placeholder="Jumlah Administrasi" class="form-control" type="text">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Jenis Administrasi</label>
                                    <div class="col-md-9">
                                        <input name="nama_bunga" placeholder="Jenis Administrasi" class="form-control" type="text">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url();?>adscontr/ajax_list",
                "type": "POST"
            },
    ...
    function add_biaya()
    {
        ...
        $('.modal-title').text('Tambah Administrasi'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_biaya(id)
    {
        ...
        $.ajax({
            url : "<?php echo base_url();?>adscontr/ajax_edit/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="nama_administrasi"]').val(data.nama_administrasi);
                ...
                $('.modal-title').text('Edit Administrasi'); // Set title to Bootstrap modal title
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo base_url();?>adscontr/ajax_add";
        } else {
            url = "<?php echo base_url();?>adscontr/ajax_update";
        }
    ...
    function delete_biaya(id)
    {
        if(confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url : "<?php echo base_url();?>adscontr/ajax_delete/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
